...
import Addmempop from './Addmempop';

const Transition = React.forwardRef(function Transition(props, ref) {
  return <Slide direction="up" ref={ref} {...props} />;
});

export default function Addmempopcaller(props,darkMode) {
    ...
    <React.Fragment>
      <Dialog
        ...
        sx={{
          ...
          '& .MuiPaper-root': {
            ...
            height: '500px', // Set custom height if needed
          },
        }}
      ...
      >
        <DialogContent>
            ...
            <Addmempop  event_id={props.event_id} team_id={props.team_id} />
        </DialogContent>
      </Dialog>
    </React.Fragment>
  );
